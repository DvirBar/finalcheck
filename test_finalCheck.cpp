...
bool dragonDenTest()
{
    ...
    string input("2\nJimmy Wizard\nPikachu Fighter");
    string deck("Dragon\nDragon\nDragon\nDragon\nDragon");
    string expectedOutputFilename("/home/mtm/public/2122b/ex4/tests/dragonDen_test_expected.txt");
...
bool vampireLairTest()
{
    ...
    string input("2\nItay Fighter\nPikachu Rogue");
    string deck("Vampire\nVampire\nVampire\nVampire\nVampire");
    string expectedOutputFilename("/home/mtm/public/2122b/ex4/tests/vampireLair_test_expected.txt");
    return GeneralGameSimulationTest(tmp_file, input, deck, expectedOutputFilename);
}
...
bool goblinCaveTest()
{
    ...
    string input("2\nItay Wizard\nPikachu Rogue");
    string deck("Goblin\nGoblin\nGoblin\nGoblin\nGoblin");
    string expectedOutputFilename("/home/mtm/public/2122b/ex4/tests/goblinCave_test_expected.txt");
    return GeneralGameSimulationTest(tmp_file, input, deck, expectedOutputFilename);
}
...
bool nonMostersTest()
{
    ...
    string input("2\nItay Wizard\nPikachu Rogue");
    string deck("Fairy\nBarfight\nPitfall\nTreasure\nFairy");
    string expectedOutputFilename("/home/mtm/public/2122b/ex4/tests/noMonster_test_expected.txt");
    return GeneralGameSimulationTest(tmp_file, input, deck, expectedOutputFilename);
}
...
bool roundLimitTest()
{
    ...
    string input("2\nmatamDalf Wizard\nrocky Fighter");
    string deck("Fairy\nFairy\nFairy\nFairy\nFairy");
    string expectedOutputFilename("/home/mtm/public/2122b/ex4/tests/roundLimit_test_expected.txt");
    return GeneralGameSimulationTest(tmp_file, input, deck, expectedOutputFilename);
}
...
bool allTenTest()
{
    ...
    string input("2\nmatamDalf Wizard\nrocky Fighter");
    string deck("Goblin\nGoblin\nGoblin\nGoblin\nGoblin");
    string expectedOutputFilename("/home/mtm/public/2122b/ex4/tests/allTen_test_expected.txt");
    return GeneralGameSimulationTest(tmp_file, input, deck, expectedOutputFilename);
}
...
bool badPlayerInputTest()
{
    ...
    string input("2\nmatamDalf Wizardd\nmatamDalf rogoe\nmatamDalf Wizard\nrocky Fighter");
    string deck("Goblin\nVampire\nGoblin\nGoblin\nDragon");
    string expectedOutputFilename("/home/mtm/public/2122b/ex4/tests/badPlayerInput_test_expected.txt");
    return GeneralGameSimulationTest(tmp_file, input, deck, expectedOutputFilename);
}
...
bool merchantInputTest()
{
    ...
    string input("2\nmatamDalf Wizardd\nmatamDalf rogoe\nmatamDalf Wizard\nrocky Fighter\n"
                 ...
                 "0\n");
    string deck("Goblin\nGoblin\nMerchant\nMerchant\nDragon");
    string expectedOutputFilename("/home/mtm/public/2122b/ex4/tests/merchantInput_test_expected.txt");
    return GeneralGameSimulationTest(tmp_file, input, deck, expectedOutputFilename);
}
...
bool badSizeTest()
{
	...
	bool flag= false;
    try{
        Mtmchkin("/home/mtm/public/2122b/ex4/inputs/empty.txt");
    }
...
bool badFormatTest()
{
    ...
    bool flag = false;
    try {
        Mtmchkin("/home/mtm/public/2122b/ex4/inputs/badFormat_test.txt");
    }
...
bool badFormatStartTest()
{
    ...
    bool flag = false;
    try {
        Mtmchkin("/home/mtm/public/2122b/ex4/inputs/badFormat_test_start_of_file.txt");
    }
    catch(const DeckFileFormatError& e){
